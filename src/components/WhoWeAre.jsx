const WhoWeAre = () => {
  return (
    <section id="who_we_are" className="bg-[#39b54a] h-dvh text-gray-900 text-center">
      <div className="mx-10 px-6 py-24 flex flex-col items-center">
        <div className="mt-4 mb-12">
          <p className="font-medium text-base mb-2 uppercase">
            a passionate team of Visual StoryTellers
          </p>
          <h2 className="text-white font-medium capitalize text-8xl mb-8">
            We are kana media
          </h2>
          <hr className="bg-gray-400 w-6/12 mx-auto" />
        </div>
        <p className="text-center text-xl font-medium tracking-wide leading-relaxed md:max-w-[85ch]">
